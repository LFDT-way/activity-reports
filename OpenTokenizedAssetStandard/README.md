...
Per-user activity for 2024–2026 extracted from the archive for the 6 users listed in `groups.yml` (2 with activity).
...
| [`pv-sarvesh`](pv-sarvesh/pv-sarvesh_activity.md) | 0 | — | — | 0 | 0 | 1 |
| [`pv-somyaditya`](pv-somyaditya/pv-somyaditya_activity.md) | 0 | — | — | 0 | 0 | 1 |
| [`pv-suren`](pv-suren/pv-suren_activity.md) | 0 | — | — | 0 | 0 | 1 |
