...
| `bevel-operator-fabric-committers` | member |

Repository access granted through those teams (3 repos):

| Repository | Access | Granted by |
| --- | --- | --- |
| `bevel` | maintain | `bevel-committers` (maintain), `bevel-contributors` (read), `bevel-operator-fabric-committers` (read) |
| `bevel-operator-fabric` | maintain | `bevel-committers` (maintain), `bevel-operator-fabric-committers` (maintain), `bevel-contributors` (read) |
| `bevel-samples` | write | `bevel-committers` (write), `bevel-contributors` (read), `bevel-operator-fabric-committers` (read) |
